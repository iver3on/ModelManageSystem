		...
		<div class="container-fluid">
			<div class="row">
				<div id="header" class="col-sm-12">
					<h3 class="my-title"><span class="glyphicon glyphicon-search text-primary"></span> 审核模型</h3>
				</div>
			</div>
			<div class="row">
			<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table table-bordered table-striped">
						...
						<td>${model.state}</td>
						<td><a href="model/${model.id}/examDetail" class="btn btn-default btn-sm">执行审核</a></td>
						</tr>	
						</c:forEach>
						</tbody>
					</table>
