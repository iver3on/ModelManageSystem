		...
		<div class="container-fluid">
			<div class="row">
				<div id="header" class="col-sm-12">
					<h3 class="my-title"><span class="glyphicon glyphicon-search text-primary"></span> 修改模型</h3>
				</div>
			</div>
	...
	<div class="row">
				<div class="col-md-12">
					<table class="table table-bordered table-striped">
						...
						<td>${model.state}</td>
						<td><a href="model/${model.id}/changeDetail" class="btn btn-default btn-sm">修改名称</a></td>
						</tr>	
						</c:forEach>
						</tbody>
					</table>
